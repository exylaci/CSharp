...
{
    [Required(ErrorMessage = "A telejs név megadása kötelező")]     //A kapott adatok ellenőrzése, már a bevitelükkor 
    [StringLength(100, MinimumLength = 3, ErrorMessage = "A név legalább 3 karakter kell legyen")]
    public string FullName { get; set; } = string.Empty;

    [Required(ErrorMessage = "Email címet kötelező megadni")]
    [EmailAddress(ErrorMessage = "Hibás email cím formátum")]
    [StringLength(150, ErrorMessage = "Az emai cím nem lehet hosszabb 150 karaktermél")]

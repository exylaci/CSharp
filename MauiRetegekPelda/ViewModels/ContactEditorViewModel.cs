...
public sealed class ContactEditorViewModel : BaseViewModel
{
...
//               a műveletek: AddTagCommand, RemoveTagCommand, ResetCommand, SaveCommand
    ...
    {
        await Application.Current.MainPage.DisplayAlertAsync("Mentés",
            $"Név: {Name}{Environment.NewLine}Email: {Email}{Environment.NewLine}Telefon: {Phone}{Environment.NewLine}Tagek: {Tags.Count}",
            "OK");
        //DisplayAlertAsync: kb. mint a WindowsForm-ban a MessageBox. (cimke,szöveg,gomb)
    }

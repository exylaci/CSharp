DROP DATABASE IF EXISTS `Szallashelyek_Teszt`;
CREATE DATABASE `Szallashelyek_Teszt`
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_0900_ai_ci;
USE `Szallashelyek_Teszt`;
...
CREATE TABLE IF NOT EXISTS `Camping` (
  ...
  CONSTRAINT `FK_Camping_Accommodation`
    FOREIGN KEY (`CampingId`) REFERENCES `Accommodation`(`Id`)
    ON UPDATE CASCADE
    ON DELETE RESTRICT
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `Building` (
  ...
  CONSTRAINT `FK_Building_Accommodation`
    FOREIGN KEY (`BuildingId`) REFERENCES `Accommodation`(`Id`)
    ON UPDATE CASCADE
    ON DELETE RESTRICT
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `Guesthouse` (
  ...
  CONSTRAINT `FK_Guesthouse_Building`
    FOREIGN KEY (`GuesthouseId`) REFERENCES `Building`(`BuildingId`)
    ON UPDATE CASCADE
    ON DELETE RESTRICT
) ENGINE=InnoDB;
